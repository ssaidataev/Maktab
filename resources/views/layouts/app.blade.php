...
<main>
    ...
    <!-- catrgory-area -->
    <section class="tp-category-area bg-bottom grey-bg pt-110 pb-80 wow fadeInUp" data-wow-duration=".8s" data-wow-delay=".3s" data-background="assets/img/bg/shape-bg-1.png">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title mb-70">
    ...
    <!-- testimonial-area -->
    <section class="testimonial-area bg-bottom pt-115 pb-90  wow fadeInUp" data-wow-duration=".8s" data-wow-delay=".3s" data-background="assets/img/bg/shape-bg-1.png">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title text-center mb-65">
